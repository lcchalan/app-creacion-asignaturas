...
LUIS v31 utiliza exclusivamente el contrato canónico `3.0.0` para Guías Didácticas nuevas.
...
La IA no decide la numeración. LUIS construye la jerarquía desde las relaciones de la oferta académica:

- `Unidad 1: ...`
- `1.1. ...`
- `1.1.1. ...`

A la IA se le entregan `sourceId` y encabezados institucionales; la respuesta contiene únicamente el desarrollo didáctico de cada sección. LUIS monta los encabezados después de validar que exista exactamente una sección por cada `sourceId`.
...
La selección debe ser coherente con resultado de aprendizaje, metodología y Taxonomía de Bloom. LUIS valida la correspondencia de tipos institucionales y genera el guion con dos tablas:
